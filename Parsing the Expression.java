...
public class HomeworkOne
{
   public static void main(String[] args)
   {
      ...
      while(true)
      {
         ...
         String expression = infile.next();
         Boolean result = tokenize(expression);
         System.out.println(result);
      }
   }
   
   public static TreeNode treeify(String exp)
   {
   ...
   public static boolean tokenize(String exp)
   {
      if(exp.contains("|") || exp.contains("&") || exp.contains("!"))
   ...
   public static boolean trueOrFalse(String symbol)
   {
